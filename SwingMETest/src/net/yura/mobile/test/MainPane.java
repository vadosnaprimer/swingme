...
public class MainPane extends DesktopPane implements ActionListener {
    ...
    private Section addSection(String a,Section section) {
        ...
        mainPanel.add( section.makeButton(a, "openSection") );
        return section;
    ...
    public void actionPerformed(String actionCommand) {
        ...
        if ("exit".equals(actionCommand)) {
            ...
            if (mainPanel==null) {
                ...
                mainPanel = new Panel( new FlowLayout(Graphics.VCENTER) );
                ...
                try {
                    ...
                    mainPanel.add( new Label("no BlueTooth") );
                    mainPanel.add( new Label( th.toString() ) );
                }
            ...
            addToScrollPane(mainPanel, mainMenu, makeButton("Exit","exit") );
