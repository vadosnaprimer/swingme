...
public class LandmarkStore {
	 ...
	 */
	public void addCategory(String categoryName) throws IllegalArgumentException, NullPointerException,
	 ...
	 */
	public static void createLandmarkStore(String storeName) throws NullPointerException, IllegalArgumentException, IOException, 
