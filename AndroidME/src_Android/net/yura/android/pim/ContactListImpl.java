...
public class ContactListImpl extends AbstractPIMList implements ContactList {
	...
	ContactListImpl(String name, int mode) {
		...
		setFieldInfos(new FieldInfo[] {
		        CONTACT_ADDR_FIELD_INFO,
		        CONTACT_EMAIL_FIELD_INFO,
		        CONTACT_NAME_FIELD_INFO,
		        CONTACT_TEL_FIELD_INFO,
		        CONTACT_NOTE_FIELD_INFO,
		        CONTACT_FORMATTED_NAME_FIELD_INFO,
		        CONTACT_UID_FIELD_INFO
		});
	}
