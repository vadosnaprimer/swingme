...
public class Loader {
	...
	private static void loadNode(Node node) throws IOException
	{
		...
		int alpha = readByte();
		node.setAlphaFactor( alpha / 255.0f );
