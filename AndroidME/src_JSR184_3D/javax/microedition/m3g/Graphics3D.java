...
//JP import javax.microedition.m3g.lcdui.Graphics;
//import javax.microedition.m3g.midpemulator.MIDPEmulator;
//import javax.microedition.m3g.util.Reflection;

import javax.microedition.khronos.opengles.GL11;
//JP import javax.media.opengl.GLCanvas;
//import javax.media.opengl.GLDrawable;
import java.util.ArrayList;

import java.nio.*;
//JP import javax.media.opengl.glu.*;
...
//JP	private GLCanvas currentGLCanvas;
//JP	private RenderEventListener currentRenderListener;
...
//JP	public void bindTarget(Object target, RenderEventListener renderListener)
//	{
...
//	}
	...
	{
//JP		if (target instanceof Graphics)
//		{
//			this.renderTarget = target;
//			GLCanvas canvas = MIDPEmulator.getInstance().getRenderTarget((Graphics)target);
//			this.currentGLCanvas = canvas;
...
//	}
	...
	{
//JP		if (this.currentGLCanvas != null)
//		{
...
//			    GLDrawable d = (GLDrawable)Reflection.getField(this.currentGLCanvas, "drawable");
//			    d.swapBuffers();
//			}
//		}
//		this.currentGLCanvas = null;
	...
	public void render(VertexBuffer vertices, IndexBuffer triangles, Appearance appearance, Transform transform)
	{
		...
		pos.position(0);
		gl.glVertexPointer(positions.getComponentCount(), GL11.GL_FLOAT, 0, pos);
		...
		if(normals != null) {
			...
			gl.glNormalPointer(GL11.GL_FLOAT, 0, norm);
		...
		for(int i = 0; i < 8; ++i) {
			...
			gl.glActiveTexture(GL11.GL_TEXTURE0 + i);
			...
			if(texcoords != null) {
				...
				gl.glTexCoordPointer(texcoords.getComponentCount(), GL11.GL_FLOAT, 0, tex);
...
//JP        if(triangles instanceof TriangleStripArray)
//		{
//			IntBuffer indices = triangles.getBuffer();
//			indices.position(0);
//			gl.glDrawElements(GL11.GL_TRIANGLE_STRIP, triangles.getIndexCount(), GL11.GL_UNSIGNED_INT, indices);
//		}
//		else
//			gl.glDrawElements(GL11.GL_TRIANGLES, triangles.getIndexCount(), GL11.GL_UNSIGNED_INT, triangles.getBuffer());
...
//JP		return MIDPEmulator.getInstance().getGL();
		return null;
	}
