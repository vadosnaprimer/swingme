...
class RenderVertices {
    ...
    static void setAppearanceMaterial(GL gl, Material material)
    {
      ...
      if (material != null)
      {
          ...
          gl.glMaterialf (  GL.GL_FRONT_AND_BACK, GL.GL_SHININESS,  material.getShininess() );
          gl.glMaterialfv(  GL.GL_FRONT_AND_BACK, GL.GL_AMBIENT,   getColorArray(material.getColor(Material.AMBIENT) ), 0);
          gl.glMaterialfv(  GL.GL_FRONT_AND_BACK, GL.GL_DIFFUSE,   getColorArray(material.getColor(Material.DIFFUSE) ), 0);
          gl.glMaterialfv(  GL.GL_FRONT_AND_BACK, GL.GL_SPECULAR,  getColorArray(material.getColor(Material.SPECULAR)), 0);
          gl.glMaterialfv(  GL.GL_FRONT_AND_BACK, GL.GL_EMISSION,  getColorArray(material.getColor(Material.EMISSIVE)), 0);
      } 
      else {
...
//          polygonMode.isTwoSidedLightingEnabled()
    ...
    static void setAppearanceFog(GL gl, Fog fog) {
        ...
        if (fog != null)
        {
            ...
            gl.glFogf(GL.GL_FOG_COLOR, fog.getColor() );
 ...
 //            gl.glAlphaFunc(GL.GL_GEQUAL, compositingMode.getAlphaThreshold() );
...
//      GL.GL_TEXTURE_2D, 
//      nivel, // nivel 
//      GL.GL_RGBA, // internalformat : GL_ALPHA, GL_ALPHA4, GL_ALPHA8, GL_ALPHA12, GL_ALPHA16, GL_LUMINANCE, GL_LUMINANCE4, GL_LUMINANCE8, GL_LUMINANCE12, GL_LUMINANCE16, GL_LUMINANCE_ALPHA, GL_LUMINANCE4_ALPHA4, GL_LUMINANCE6_ALPHA2, GL_LUMINANCE8_ALPHA8, GL_LUMINANCE12_ALPHA4, GL_LUMINANCE12_ALPHA12, GL_LUMINANCE16_ALPHA16, GL_INTENSITY, GL_INTENSITY4, GL_INTENSITY8, GL_INTENSITY12, GL_INTENSITY16, GL_R3_G3_B2, GL_RGB, GL_RGB4, GL_RGB5, GL_RGB8, GL_RGB10, GL_RGB12, GL_RGB16, GL_RGBA, GL_RGBA2, GL_RGBA4, GL_RGB5_A1, GL_RGBA8, GL_RGB10_A2, GL_RGBA12, or GL_RGBA16
//      texture2D.getImage().getWidth(), //width
//      texture2D.getImage().getHeight(), //height
//      0, // border 0..1
//      GL.GL_RGBA, //GL_COLOR_INDEX, GL_RED, GL_GREEN, GL_BLUE, GL_ALPHA, GL_RGB, GL_RGBA, GL_LUMINANCE, and GL_LUMINANCE_ALPHA
//      GL.GL_UNSIGNED_BYTE, //GL_UNSIGNED_BYTE, GL_BYTE, GL_BITMAP, GL_UNSIGNED_SHORT, GL_SHORT, GL_UNSIGNED_INT, GL_INT, and GL_FLOAT.
