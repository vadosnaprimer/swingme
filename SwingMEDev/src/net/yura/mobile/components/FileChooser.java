package net.yura.mobile.components;
...
//    private boolean showOnlyNew;
    ...
    public FileChooser() {
        ...
        Menu popupMenu = new Menu( "Menu" ,"mainMenu");
        ...
        Menu showMenu = new Menu("Show","showMenu");
        ...
        Menu viewMenu = new Menu("View","viewMenu");
        ...
        setWindowCommand(1, new CommandButton("Cancel","cancel"));
